...
def gen_match_insert(home_name, away_name, league, year, home_score, away_score, date):
    statement = 'INSERT INTO MATCH_TABLE(MATCH_HOME_TEAM_NAME, MATCH_AWAY_TEAM_NAME, LEAGUE_NAME, SEASON_YEAR, MATCH_HOME_SCORE, MATCH_AWAY_SCORE, MATCH_DATE) VALUES'
